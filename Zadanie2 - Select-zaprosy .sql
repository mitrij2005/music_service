...
SELECT treki.nazvanie_treka, treki.dlitelnost FROM treki
ORDER BY treki.dlitelnost DESC
LIMIT 1;
...
--      UPPER(treki.nazvanie_treka) LIKE '% МОЙ %' OR UPPER(treki.nazvanie_treka) LIKE 'МОЙ %' OR UPPER(treki.nazvanie_treka) LIKE '% МОЙ' OR; 

SELECT treki.nazvanie_treka FROM treki 
WHERE UPPER(treki.nazvanie_treka) LIKE '% MY %' OR UPPER(treki.nazvanie_treka) LIKE 'MY %' OR UPPER(treki.nazvanie_treka) LIKE '% MY' OR
      UPPER(treki.nazvanie_treka) LIKE '% МОЙ %' OR UPPER(treki.nazvanie_treka) LIKE 'МОЙ %' OR UPPER(treki.nazvanie_treka) LIKE '% МОЙ' OR
      UPPER(treki.nazvanie_treka) = 'MY' OR
      UPPER(treki.nazvanie_treka) = 'МОЙ'; 